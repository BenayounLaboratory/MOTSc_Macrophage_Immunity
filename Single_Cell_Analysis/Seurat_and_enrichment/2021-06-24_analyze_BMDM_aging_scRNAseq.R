...
my.bmdm.singlets <- FindNeighbors(my.bmdm, dims = 1:30)
...
# 
pdf(paste(Sys.Date(),"BMDM_aging_UMAP_clusters_0.1_res_Singlets.pdf", sep = "_"), height = 5, width = 6.5)
...
# Cd74      0.000000e+00  3.6328124 1.000 0.094  0.000000e+00
# H2-Aa     0.000000e+00  2.5266737 0.829 0.013  0.000000e+00
# H2-Eb1    0.000000e+00  2.1308471 0.661 0.006  0.000000e+00
# H2-Ab1    0.000000e+00  2.0547666 0.829 0.035  0.000000e+00
# Ciita     0.000000e+00  0.4376978 0.308 0.008  0.000000e+00
# H2-DMa   9.207161e-157  0.8162339 0.647 0.159 1.070056e-152
# Ccr2     6.766303e-136  0.4952581 0.218 0.019 7.863797e-132
# Itgb7    1.744060e-101  0.2590604 0.174 0.016  2.026946e-97
# Tmem176b  2.192494e-90  0.8381316 0.622 0.219  2.548116e-86
# Spp1      1.426579e-88 -1.3683279 0.941 0.989  1.657971e-84
...
#                  p_val avg_logFC pct.1 pct.2     p_val_adj
# Rsad2      0 1.9459820 0.757 0.090         0
# Ifit1      0 1.7658740 0.796 0.112         0
# Cxcl10     0 1.7146124 0.379 0.016         0
# Ifit3      0 1.4393522 0.817 0.070         0
# Ifit2      0 1.1963492 0.719 0.045         0
# Cmpk2      0 1.0699520 0.580 0.053         0
# Ifit3b     0 0.7813066 0.497 0.020         0
# Gbp2       0 0.7571458 0.488 0.027         0
# Ifi211     0 0.7383307 0.618 0.062         0
# Ifi209     0 0.6242048 0.524 0.038         0
...
# ######### fancy plotting with mutliple top annotations 
# #### Not working at alll
# DefaultAssay(my.bmdm.singlets) <- "RNA"
# my.bmdm.singlets <- NormalizeData(object = my.bmdm.singlets, normalization.method = "LogNormalize",  scale.factor = 10000)
# my.bmdm.singlets <- ScaleData(object = my.bmdm.singlets, vars.to.regress = c("nFeature_RNA", "percent.mito", "S.Score", "G2M.Score"))
# 
# get_top_genes <- function (dataset, markers, n) {
#   mat <- GetAssayData(object = dataset, assay = DefaultAssay(dataset), slot = "scale.data")
#   int_features <- rownames(mat)
...
# }
# 
# plot_heatmap2(dataset = my.bmdm.singlets, 
#              markers = bmdm.markers,
#              sort_var = c("SCT_snn_res.0.2","Condition"),
#              anno_var = c("SCT_snn_res.0.2","Condition","percent.mt","S.Score","G2M.Score"),
